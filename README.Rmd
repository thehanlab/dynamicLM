...
We will consider linear and quadratic landmark interactions with the covariates (given by `func_covars = "quadratic"`) and the landmarks (`func_lms = "quadratic"`). The covariates that should have these landmark interactions are given in
`pred_covars`.
