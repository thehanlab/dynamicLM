...
We will consider constant and linear landmark interactions (`func_covars`) with the covariates and linear effects from the landmarks themselves (`func_LMs`). The covariates that should have these landmark interactions are given in `LMcovars`.
