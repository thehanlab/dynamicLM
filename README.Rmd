...
plotrisk(supermodel, dat, format = "long", ylim = c(0, 0.35), 
         x.legend = "topleft")
```
We can see that the individual (id = 29) with lower stage, low and constant bilirunbin levels, and constant albumin levels generally has a lower and largely unchanged 5-year risk of transplant. The individual (id = 231) with higher stage has a higher initial risk, but an increase in albumin levels at around landmark 2, leads to a much improved (lower) risk of transplant. This can be explained by the dynamic hazard rate of albumin (seen above) which is protective for higher levels and has a larger effect than bilirunbin.
