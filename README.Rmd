...
> A more detailed mathematical explanation of the landmark supermodel is detailed in [a separate file](https://github.com/thehanlab/dynamicLM/blob/extension/summary-metric/tutorials/theory-landmark-supermodel.md).
...
Package documentation can be found in [this pdf](https://github.com/thehanlab/dynamicLM/blob/main/man/dynamicLM_1.0.0.pdf) and more information about any function can be obtained by running `?function_name`.
