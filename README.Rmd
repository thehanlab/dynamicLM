...
when fitting the model (i.e., when calling `dynls`.

**External validation** can be performed by passing new 
data through the `data` argument. This data can be a LMdataframe or a dataframe 
(in which case `tLM` must be specified).
